...
const Footer = () => {
    return (
        <footer className='border-t py-12'>
            <div className='md:max-w-7xl sm:max-w-3xl mx-auto grid grid-cols-1  md:grid-cols-4 gap-8 px-4 lg:px-0'>
                <div>
                    <h3 className='text-lg text-gray-800 mb-4'>Newsletter</h3>
                    <p className='text-gray-500 mb-4'>
                        Be the first to hear about new products, exclusive offer and online offers.
                    </p>
                    ...
                    <form className='flex'>
                        <input
                            ...
                            className='p-3 w-full text-sm border-t border-l border-gray-300 rounded-l-md 
                ...
                <div>
                    ...
                    <p className=''>
                        <FiPhoneCall className="size-5 inline-block mr-2 " />
                        +1 (132)44222
                    </p>
                </div>
            </div>
