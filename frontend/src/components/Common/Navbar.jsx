        ...
        <>
            <nav className=' md:max-w-7xl sm:max-w-3xl mx-auto flex items-center justify-between py-4  px-6'>
                ...
                <div className='flex items-center space-x-4'>
                    ...
                    <button className='relative hpver:text-black' onClick={toggleCartDrawer}>
            ...
            >
                <div className='flex justify-end p-4 '>
                    <button onClick={toggleNavDrawer} className='focus:border border-2 rounded-full text-gray-500 focus:text-gray-600'>
